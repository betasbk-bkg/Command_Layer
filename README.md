...
The package contains simulation code, Webots validation files, saved seed-level results, analysis tables, six figure files (five manuscript figures plus one supporting grid-relay figure), citation metadata, a validation summary, a claim-level reproducibility checker, and a freshness-return analysis script. It does not include the manuscript file or pre-release reproducibility logs.

Archived on Zenodo (all versions): https://doi.org/10.5281/zenodo.21310895
This concept DOI resolves to the latest published release; this package is the v1.4.0 submission package.
...
- Use of generative AI: ChatGPT (OpenAI) was used for language refinement, editorial drafting assistance, and code organization support in the manuscript and repository documentation. It was not used to generate data, select models, derive results, or make scientific claims.
