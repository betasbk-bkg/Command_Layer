...
The Webots command result is conditional. It supports a modest degraded-regime command-layer benefit, especially for operational score, but it does not justify universal command superiority.
