...
The package contains simulation code, Webots validation files, saved seed-level results, analysis tables, six core figures, a validation summary, and a claim-level reproducibility checker. It does not include the manuscript file or pre-release reproducibility logs.
...
It does not claim hardware validation, human-subject validation, universal command superiority, or relay-rich superiority.
