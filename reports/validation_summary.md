...
The included checker verifies required files, row counts, table-level contrasts, raw mean reconstructions for grid-world and Webots contrasts, and diagnostic AUROC values. A package passes only when all checks succeed; the released package passes 303/303.
